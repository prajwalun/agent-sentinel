...
### Fixed
- **Critical**: Fixed dependency resolution error with `opentelemetry-instrumentation>=0.40.0` by updating to `>=0.40b0` to support beta versions
- Resolved pip installation failure due to OpenTelemetry instrumentation version constraint
