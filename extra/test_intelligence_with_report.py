#!/usr/bin/env python3
"""
Test Agent Sentinel Intelligence with A2A Security Report

This script reads the real A2A security report and feeds it to the
sentinel-intelligence agent for enhanced analysis and threat intelligence.
"""
...
# Add the intelligence layer to path
sys.path.insert(0, str(Path(__file__).parent / "agent-sentinel-intelligence" / "src"))
...
def main():
    ...
    report_path = "weave-streamlined-2file-output/src/reports/real_a2a_security_report_20250713_043259.txt"
